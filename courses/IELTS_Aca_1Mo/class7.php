...
$minTier = lesson_min_tier($db, 'IELTS_Aca_1Mo', 7, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 4</span><span class="class-chip">Class 7 of 8</span></div>
                    <h1 class="class-title"><span class="class-title-line">Reading Test 2</span><span class="class-title-line">Process Description &amp; Passive Voice</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_1Mo', 7); ?>
