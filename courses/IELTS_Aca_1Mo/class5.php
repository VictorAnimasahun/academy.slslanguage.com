...
$minTier = lesson_min_tier($db, 'IELTS_Aca_1Mo', 5, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 3</span><span class="class-chip">Class 5 of 8</span></div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Writing Test 1 (Timed) <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 5, 'Writing Test 1 (Timed)') ?></h5>
                    ...
                    <div class="lesson-item">
                        <h5>Listening Formats <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 5, 'Listening Formats') ?></h5>
