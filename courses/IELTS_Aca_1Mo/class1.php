...
$minTier = lesson_min_tier($db, 'IELTS_Aca_1Mo', 1, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                <div class="class-head-icon"><i class="bi bi-play-circle"></i></div>
                <div>
                    <div class="class-chips"><span class="class-chip">Week 1</span><span class="class-chip">Class 1 of 8</span></div>
                    <h1 class="class-title"><span class="class-title-line">Orientation & Diagnostic Assessment<span class="badge bg-success ms-2">Free</span></span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_1Mo', 1); ?>
