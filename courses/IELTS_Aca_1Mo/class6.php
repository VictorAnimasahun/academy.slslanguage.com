...
$minTier = lesson_min_tier($db, 'IELTS_Aca_1Mo', 6, 'intermediate');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Listening Test 2 · Map Description & Passive Voice — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Listening Test 2 · Map Description & Passive Voice</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 3</span><span class="class-chip">Class 6 of 8</span></div>
                    <h1 class="class-title"><span class="class-title-line">Listening Test 2</span><span class="class-title-line">Map Description &amp; Passive Voice</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Listening Test 2 <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 6, 'Listening Test 2') ?></h5>
                    ...
                    <div class="lesson-item">
                        <h5>Map Description &amp; Passive Voice <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 6, 'Map Description &amp; Passive Voice') ?></h5>
                        <ul><li>Map description phrases and passive voice</li><li>Strengthening weak arguments</li><li>Exercises on both</li></ul>
                        <?= lesson_part_button($db, 'IELTS_Aca_1Mo', 6, 'Map Description &amp; Passive Voice') ?>
                    </div>
                </div>
            <?php endif; ?>

            <div class="lesson-nav">
                <a href="class5.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class7.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
