...
$minTier = lesson_min_tier($db, 'IELTS_Aca_1Mo', 4, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 2</span><span class="class-chip">Class 4 of 8</span></div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Speaking Test 1 <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 4, 'Speaking Test 1') ?></h5>
                    ...
                    <div class="lesson-item">
                        <h5>Comparative Structures &amp; TEE <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 4, 'Comparative Structures &amp; TEE') ?></h5>
                        <ul><li>Comparative/superlative structures for Task 1</li><li>TEE body paragraph structure</li><li>Exercises on both</li></ul>
                        <?= lesson_part_button($db, 'IELTS_Aca_1Mo', 4, 'Comparative Structures &amp; TEE') ?>
                    </div>
                </div>
            <?php endif; ?>
