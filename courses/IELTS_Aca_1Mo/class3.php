...
$minTier = lesson_min_tier($db, 'IELTS_Aca_1Mo', 3, 'intermediate');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Reading Test 1 · Trend Vocabulary & Paraphrasing — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Reading Test 1 · Trend Vocabulary & Paraphrasing</li>
                </ol>
            </nav>

            <div class="class-head">
                <div class="class-head-icon"><i class="bi bi-book"></i></div>
                <div>
                    <div class="class-chips"><span class="class-chip">Week 2</span><span class="class-chip">Class 3 of 8</span></div>
                    <h1 class="class-title"><span class="class-title-line">Reading Test 1</span><span class="class-title-line">Trend Vocabulary &amp; Paraphrasing</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Reading Test 1 <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 3, 'Reading Test 1') ?></h5>
                    ...
                    <div class="lesson-item">
                        <h5>Trend Vocabulary &amp; Paraphrasing <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 3, 'Trend Vocabulary &amp; Paraphrasing') ?></h5>
                        <ul><li>Trend vocabulary and sentence structures</li><li>Paraphrasing questions and thesis statements</li><li>Exercises on both</li></ul>
                        <?= lesson_part_button($db, 'IELTS_Aca_1Mo', 3, 'Trend Vocabulary &amp; Paraphrasing') ?>
                    </div>
                </div>
            <?php endif; ?>

            <div class="lesson-nav">
                <a href="class2.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class4.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
