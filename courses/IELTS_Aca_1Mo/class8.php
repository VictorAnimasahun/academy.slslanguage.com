...
$minTier = lesson_min_tier($db, 'IELTS_Aca_1Mo', 8, 'intermediate');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Mock Test 1 — Full Timed (L, R, W, S) — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Mock Test 1 — Full Timed (L, R, W, S)</li>
                </ol>
            </nav>

            <div class="class-head">
                <div class="class-head-icon"><i class="bi bi-clipboard-check"></i></div>
                <div>
                    <div class="class-chips"><span class="class-chip">Week 4</span><span class="class-chip">Class 8 of 8</span></div>
                    <h1 class="class-title"><span class="class-title-line">Mock Test 1 — Full Timed (L, R, W, S)</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_1Mo', 8); ?>
            ...
            <div class="lesson-nav">
                ...
                <a href="course_overview.php" class="btn btn-primary flex-fill text-truncate">Back to the course<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
