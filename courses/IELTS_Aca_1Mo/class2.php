...
$minTier = lesson_min_tier($db, 'IELTS_Aca_1Mo', 2, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 1</span><span class="class-chip">Class 2 of 8</span></div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Listening Test 1 <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 2, 'Listening Test 1') ?></h5>
                    ...
                    <div class="lesson-item">
                        <h5>Writing Task Overview <?= lesson_kind_badge($db, 'IELTS_Aca_1Mo', 2, 'Writing Task Overview') ?></h5>
                        ...
                        <?= lesson_part_button($db, 'IELTS_Aca_1Mo', 2, 'Writing Task Overview') ?>
                    </div>
                </div>
            <?php endif; ?>
