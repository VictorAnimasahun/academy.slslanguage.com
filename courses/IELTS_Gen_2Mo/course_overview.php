...
$stmt = $db->prepare("SELECT * FROM courses WHERE folder_name = 'IELTS_Gen_2Mo' LIMIT 1");
$stmt->execute();
        ...
        <div class="course-card">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        <?php if ($student_tier_level >= 3): ?>
                            <span class="badge bg-success px-3 py-2">
                                <i class="bi bi-check-circle me-1"></i>Access: Advanced Plan
                            </span>
                        <?php else: ?>
                            <a href="../../upgrade.php?required=advanced"
                               class="btn btn-primary btn-sm">
                                <i class="bi bi-lightning-charge me-1"></i>Upgrade to Access
                            </a>
                        <?php endif; ?>
                        <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/intro.php?from=IELTS_Gen_2Mo" class="btn btn-outline-primary btn-sm">
                ...
                <?php foreach ($modules as $month_num => $module): ?>
                    ...
                    <div class="accordion-item mb-2" style="border-radius:10px;overflow:hidden;border:none;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
                        <h2 class="accordion-header">
                            <button class="accordion-button <?= $is_open ? '' : 'collapsed' ?>"
                                    type="button"
                                ...
                                <li class="d-flex align-items-center justify-content-between px-3 py-2 <?= $idx < count($module['lessons'])-1 ? 'border-bottom' : '' ?>"
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <?php if ($can_access && $file_path): ?>
                                            <a href="<?= ACADEMY_URL . htmlspecialchars($file_path) ?>?from=IELTS_Gen_2Mo"
            ...
            <div class="content-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-card">
                        <h4><i class="bi bi-clipboard-check me-2"></i>3 Practice Test Sets</h4>
                        <p class="mb-0">Practice Test Sets 1, 2 &amp; 3 — all four skills — spread across the 14 teaching classes.</p>
                    </div>
                    <div class="info-card">
                    ...
                    <div class="info-card">
                        ...
                        <p class="mb-0">Upgrade to the 3-Month Masterclass at any time — your progress carries over.</p>
                    </div>
                </div>
            </div>

            <div class="action-buttons">
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/intro.php?from=IELTS_Gen_2Mo" class="btn btn-primary btn-lg">
    ...
    <aside class="advert-sidebar">
        <div class="course-card" style="background:linear-gradient(135deg,#6366f1 0%,#0b77ff 100%);color:white;">
            ...
            <div class="d-grid gap-1">
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/intro.php?from=IELTS_Gen_2Mo" class="btn btn-light btn-sm">Class 1 — Free Preview</a>
                <?php if ($student_tier_level >= 2): ?>
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/class02.php?from=IELTS_Gen_2Mo" class="btn btn-outline-light btn-sm">Class 2</a>
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/class08.php?from=IELTS_Gen_2Mo" class="btn btn-outline-light btn-sm">Mock Test 1</a>
                <?php endif; ?>
                <?php if ($student_tier_level >= 3): ?>
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/class09.php?from=IELTS_Gen_2Mo" class="btn btn-outline-light btn-sm">Class 9</a>
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/class16.php?from=IELTS_Gen_2Mo" class="btn btn-outline-light btn-sm">Mock Test 2</a>
                <?php endif; ?>
                <?php if ($student_tier_level < 2): ?>
