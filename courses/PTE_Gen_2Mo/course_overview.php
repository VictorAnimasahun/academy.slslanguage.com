...
$stmt = $db->prepare("SELECT * FROM courses WHERE folder_name = 'PTE_Gen_2Mo' LIMIT 1");
$stmt->execute();
...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
                ...
                <?php foreach ($modules as $month_num => $module): ?>
                    ...
                    <div class="accordion-item mb-2" style="border-radius:10px;overflow:hidden;border:none;box-shadow:0 2px 8px rgba(0,0,0,0.06);">
                        <h2 class="accordion-header">
                            <button class="accordion-button <?= $is_open ? '' : 'collapsed' ?>" type="button"
                                ...
                                <li class="d-flex align-items-center justify-content-between px-3 py-2 <?= $idx < count($module['lessons'])-1 ? 'border-bottom' : '' ?>"
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <span class="text-muted d-flex align-items-center gap-2">
                                            <i class="bi bi-hourglass-split" style="color:#94a3b8;font-size:1rem;min-width:20px;"></i>
                                    ...
                                    <div class="d-flex align-items-center gap-2 text-muted small ms-2" style="white-space:nowrap;">
                                        ...
                                        <span class="badge bg-light text-secondary border">Soon</span>
            ...
            <div class="content-section">
                ...
                <div class="info-grid">
                    <div class="info-card"><h4><i class="bi bi-play-circle me-2"></i>Lesson Videos</h4><p class="mb-0">Curated PTE Academic video lessons for every class, covering all four skills across two months.</p></div>
                    <div class="info-card"><h4><i class="bi bi-robot me-2"></i>AI-Scored Practice</h4><p class="mb-0">Learn to work with PTE's AI scoring system — strategies that target the algorithm's exact criteria.</p></div>
                    ...
                    <div class="info-card"><h4><i class="bi bi-journal-richtext me-2"></i>2 Full Mock Exams</h4><p class="mb-0">End-of-month full timed mock exams with scored feedback and target score estimates.</p></div>
                    <div class="info-card"><h4><i class="bi bi-arrow-up-circle me-2"></i>Upgrade Anytime</h4><p class="mb-0">Upgrade to the 3-Month PTE Masterclass at any time — your progress carries over.</p></div>
                </div>
            </div>
    ...
    <aside class="advert-sidebar">
        <div class="course-card" style="background:linear-gradient(135deg,#6366f1 0%,#0b77ff 100%);color:white;">
            ...
            <p class="small mb-2">PTE Academic lessons are in development. Register your interest below.</p>
            <div class="d-grid gap-1">
                <?php if ($student_tier_level < 3): ?>
                <a href="../../upgrade.php?required=advanced" class="btn btn-warning btn-sm"><i class="bi bi-lightning-charge me-1"></i>Upgrade to Unlock</a>
                <?php endif; ?>
            </div>
        </div>
