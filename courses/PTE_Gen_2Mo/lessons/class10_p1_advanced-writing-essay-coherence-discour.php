<?php
// Advanced Writing — Essay Coherence & Discourse Markers — PTE Academic — 2-Month Plan, Class 10, piece 1 (lesson).
...
<!-- LESSON BODY END -->
<?php
render_lesson_shell($db, 'PTE_Gen_2Mo', 10, 1, ob_get_clean());
