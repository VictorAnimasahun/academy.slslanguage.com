<?php
// Reading — Multiple Choice, Re-order & Fill in Blanks — PTE Academic Masterclass — 3 Months, Class 5, piece 1 (lesson).
...
<!-- LESSON BODY END -->
<?php
render_lesson_shell($db, 'PTE_Gen_3Mo', 5, 1, ob_get_clean());
