<?php
// Advanced Reading — Speed & Complex Item Types — PTE Academic Masterclass — 3 Months, Class 11, piece 1 (lesson).
...
<!-- LESSON BODY END -->
<?php
render_lesson_shell($db, 'PTE_Gen_3Mo', 11, 1, ob_get_clean());
