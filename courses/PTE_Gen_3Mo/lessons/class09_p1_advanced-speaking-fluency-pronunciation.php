<?php
// Advanced Speaking — Fluency, Pronunciation & Oral Fluency Score — PTE Academic Masterclass — 3 Months, Class 9, piece 1 (lesson).
...
<!-- LESSON BODY END -->
<?php
render_lesson_shell($db, 'PTE_Gen_3Mo', 9, 1, ob_get_clean());
