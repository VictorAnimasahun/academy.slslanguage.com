<?php
// Mastery Speaking — Perfect Pronunciation Patterns — PTE Academic Masterclass — 3 Months, Class 17, piece 1 (lesson).
...
<!-- LESSON BODY END -->
<?php
render_lesson_shell($db, 'PTE_Gen_3Mo', 17, 1, ob_get_clean());
