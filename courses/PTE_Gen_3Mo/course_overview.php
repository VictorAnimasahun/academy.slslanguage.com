...
$stmt = $db->prepare("SELECT * FROM courses WHERE folder_name = 'PTE_Gen_3Mo' LIMIT 1");
$stmt->execute();
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="content-section">
                ...
                <div class="info-grid">
                    <div class="info-card"><h4><i class="bi bi-play-circle me-2"></i>Lesson Videos</h4><p class="mb-0">Curated PTE Academic video lessons for every class across all three months, covering all four skills.</p></div>
    ...
    <aside class="advert-sidebar">
        <div class="course-card" style="background:linear-gradient(135deg,#16a34a 0%,#0b77ff 100%);color:white;">
            ...
            <div class="d-grid gap-1">
                <?php if ($student_tier_level < 4): ?>
                <a href="../../upgrade.php?required=fluent" class="btn btn-warning btn-sm"><i class="bi bi-lightning-charge me-1"></i>Upgrade to Unlock</a>
                <?php endif; ?>
            </div>
        </div>
