    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 6</span><span class="class-chip">Class 12 of 16</span></div>
                    <h1 class="class-title"><span class="class-title-line">Complete Listening Test 3</span><span class="class-title-line">Speaking: Tasks 1–4 Review</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Complete Listening Test 3</h5>
                        <p>Test 3 — not built yet.</p>
                    </div>
                    <div class="lesson-item">
                        <h5>Speaking: Tasks 1–4 Review</h5>
                        <p>Tasks 1–4 review (tone, fluency, storytelling).</p>
                    </div>
                </div>
            <?php endif; ?>
