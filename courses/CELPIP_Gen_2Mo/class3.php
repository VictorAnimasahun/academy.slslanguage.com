...
<head>
    <meta charset="utf-8">
    <title>Complete Reading Test 1 · Writing: Argument Vocabulary — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complete Reading Test 1 · Writing: Argument Vocabulary</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    ...
                    <h1 class="class-title"><span class="class-title-line">Complete Reading Test 1</span><span class="class-title-line">Writing: Argument Vocabulary</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Complete Reading Test 1</h5>
                        <p>(Parts 1–4), full answer review.</p>
                        <a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_reading_001.php" class="btn btn-primary btn-lg" target="_blank" rel="noopener"><i class="bi bi-box-arrow-up-right me-2"></i>Open Test</a>
                    </div>
                    <div class="lesson-item">
                        <h5>Writing: Argument Vocabulary</h5>
                        <p>argument vocabulary and sentence variety.</p>
                    </div>
                </div>
            <?php endif; ?>
