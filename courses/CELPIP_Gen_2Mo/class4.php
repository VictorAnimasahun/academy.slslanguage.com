...
<head>
    <meta charset="utf-8">
    <title>Complete Speaking Test 1 · Writing: Transitions — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complete Speaking Test 1 · Writing: Transitions</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 2</span><span class="class-chip">Class 4 of 16</span></div>
                    <h1 class="class-title"><span class="class-title-line">Complete Speaking Test 1</span><span class="class-title-line">Writing: Transitions</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Complete Speaking Test 1</h5>
                        <p>(Tasks 1–8), feedback on clarity, structure, and emotion.</p>
                        <a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_speaking_001.php" class="btn btn-primary btn-lg" target="_blank" rel="noopener"><i class="bi bi-box-arrow-up-right me-2"></i>Open Test</a>
                    </div>
                    <div class="lesson-item">
                        <h5>Writing: Transitions</h5>
                        <p>transitions, collocations, and sentence-level variation.</p>
                    </div>
                </div>
            <?php endif; ?>
