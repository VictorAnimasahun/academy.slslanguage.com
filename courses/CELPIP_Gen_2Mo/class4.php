...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 2 — Reading + Speaking Focus &nbsp;·&nbsp; Class 4 of 16</p>
            <h1 class="mb-3">
                <i class="bi bi-mic me-2" style="color:#0b77ff;"></i>
                Complete Speaking Test 1 + Writing: Transitions
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><ul><li>Speaking: Complete Speaking Test 1 (Tasks 1–8), feedback on clarity, structure, and emotion.</li><li>Writing: transitions, collocations, and sentence-level variation.</li></ul></div>
