    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                <div class="class-head-icon"><i class="bi bi-compass"></i></div>
                <div>
                    <div class="class-chips"><span class="class-chip">Week 1</span><span class="class-chip">Class 1 of 16</span></div>
                    <h1 class="class-title"><span class="class-title-line">Orientation</span><span class="class-title-line">Diagnostic Assessment</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Orientation</h5>
                        <p>CELPIP format, scoring (CLB bands), and what to expect across the program.</p>
                    </div>
                    <div class="lesson-item">
                        <h5>Diagnostic Assessment</h5>
                        <p>Two assessments, taken one after the other: the Foundational English Assessment, then the Mini Diagnostic (a Listening, Reading, Writing and Speaking sample test). Together they give you a personalized starting band estimate.</p>
                        <a href="<?= ACADEMY_URL ?>courses/CELPIP_Gen/lessons/week1_foundational_assessment.php" class="btn btn-primary" target="_blank" rel="noopener">Foundational English Assessment <i class="bi bi-box-arrow-up-right ms-1"></i></a>
                        <a href="<?= ACADEMY_URL ?>courses/CELPIP_intro/celpip_mini_mock.php" class="btn btn-primary" target="_blank" rel="noopener">Mini Diagnostic (All 4 Skills) <i class="bi bi-box-arrow-up-right ms-1"></i></a>
                    </div>
                </div>
            <?php endif; ?>
