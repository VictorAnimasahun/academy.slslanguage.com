        ...
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    ...
                    <h1 class="class-title"><span class="class-title-line">Complete Speaking Test 2</span><span class="class-title-line">Writing: Intros &amp; Conclusions</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Complete Speaking Test 2</h5>
                        <p>Feedback on reasoning/persuasion tasks.</p>
                    ...
                    <div class="lesson-item">
                        <h5>Writing: Intros & Conclusions</h5>
                        <p>introductions and conclusions.</p>
                    </div>
                </div>
            <?php endif; ?>
