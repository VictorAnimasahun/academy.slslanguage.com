...
<head>
    <meta charset="utf-8">
    <title>Complete Speaking Test 2 + Writing: Intros & Conclusions — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complete Speaking Test 2 + Writing: Intros & Conclusions</li>
                </ol>
            </nav>

            <p class="text-muted small mb-1">Week 4 — Reading + Speaking Focus &nbsp;·&nbsp; Class 8 of 16</p>
            <h1 class="mb-3">
                <i class="bi bi-mic me-2" style="color:#0b77ff;"></i>
                Complete Speaking Test 2 + Writing: Intros & Conclusions
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><ul><li>Speaking: Complete Speaking Test 2, feedback on reasoning/persuasion tasks.</li><li>Writing: introductions and conclusions.</li></ul></div>
                <a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_speaking_002.php" class="btn btn-primary btn-lg" target="_blank" rel="noopener"><i class="bi bi-box-arrow-up-right me-2"></i>Open Test</a>

            <?php endif; ?>

            <div class="lesson-nav">
                <a href="class7.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class9.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
