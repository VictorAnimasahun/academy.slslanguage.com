        ...
        <div class="course-card">
            ...
            <div class="highlight-box">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <?php endif; ?>
                        <a href="<?= ACADEMY_URL ?>courses/CELPIP_intro/intro.php?from=CELPIP_Gen_2Mo" class="btn btn-outline-primary btn-sm">
                                ...
                                <li class="d-flex align-items-center justify-content-between px-3 py-2 <?= $idx < count($module['lessons'])-1 ? 'border-bottom' : '' ?>"
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <?php if ($can_access && $file_path): ?>
                                            <a href="<?= ACADEMY_URL . htmlspecialchars($file_path) ?>?from=CELPIP_Gen_2Mo" class="text-decoration-none text-dark d-flex align-items-center gap-2">
            ...
            <div class="content-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-card"><h4><i class="bi bi-journal-richtext me-2"></i>2 Full Mock Exams</h4><p class="mb-0">End-of-month full timed mock exams with written feedback and CLB band score estimates.</p></div>
            ...
            <div class="action-buttons">
                <a href="<?= ACADEMY_URL ?>courses/CELPIP_intro/intro.php?from=CELPIP_Gen_2Mo" class="btn btn-primary btn-lg">
