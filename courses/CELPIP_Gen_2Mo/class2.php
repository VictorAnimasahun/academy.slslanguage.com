...
<head>
    <meta charset="utf-8">
    <title>Complete Listening Test 1 · Writing: Letter Tone — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complete Listening Test 1 · Writing: Letter Tone</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    ...
                    <h1 class="class-title"><span class="class-title-line">Complete Listening Test 1</span><span class="class-title-line">Writing: Letter Tone</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Complete Listening Test 1</h5>
                        <p>(Parts 1–4), full answer review.</p>
                        <a href="<?= ACADEMY_URL ?>courses/CELPIP_Gen/lessons/celpip_listening_001.php" class="btn btn-primary btn-lg" target="_blank" rel="noopener"><i class="bi bi-box-arrow-up-right me-2"></i>Open Test</a>
                    </div>
                    <div class="lesson-item">
                        <h5>Writing: Letter Tone</h5>
                        <p>letter tone and vocabulary for different letter types.</p>
                    </div>
                </div>
            <?php endif; ?>
