...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 1 — Orientation + Diagnostic &nbsp;·&nbsp; Class 2 of 16</p>
            <h1 class="mb-3">
                <i class="bi bi-headphones me-2" style="color:#0b77ff;"></i>
                Complete Listening Test 1 + Writing: Letter Tone
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><ul><li>Listening: Complete Listening Test 1 (Parts 1–4), full answer review.</li><li>Writing: letter tone and vocabulary for different letter types.</li></ul></div>
