...
<head>
    <meta charset="utf-8">
    <title>Mock Test 1 — Full-Length, All 4 Sections — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Mock Test 1 — Full-Length, All 4 Sections</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 5</span><span class="class-chip">Class 9 of 16</span></div>
                    <h1 class="class-title"><span class="class-title-line">Mock Test 1 — Full-Length, All 4 Sections</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Mock Test 1 — Full-Length, All 4 Sections</h5>
                        <p>Listening, Reading, Writing, Speaking — full-length, timed.</p>
                        <a href="<?= ACADEMY_URL ?>resources/mock_tests/celpip_full_mock_a.php" class="btn btn-primary btn-lg" target="_blank" rel="noopener"><i class="bi bi-box-arrow-up-right me-2"></i>Open Test</a>
                    </div>
            ...
            <div class="lesson-nav">
                <a href="class8.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class10.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
