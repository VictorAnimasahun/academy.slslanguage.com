...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 5 — Mock Exam + Review &nbsp;·&nbsp; Class 9 of 16</p>
            <h1 class="mb-3">
                <i class="bi bi-journal-richtext me-2" style="color:#0b77ff;"></i>
                Mock Test 1 — Full-Length, All 4 Sections
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><ul><li>Mock Test 1: Listening, Reading, Writing, Speaking — full-length, timed.</li><li>Nothing else scheduled this class.</li></ul></div>
