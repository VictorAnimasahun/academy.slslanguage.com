...
<head>
    <meta charset="utf-8">
    <title>Complete Writing Test 2 · Speaking: Tasks 5–8 Review — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complete Writing Test 2 · Speaking: Tasks 5–8 Review</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 6</span><span class="class-chip">Class 11 of 16</span></div>
                    <h1 class="class-title"><span class="class-title-line">Complete Writing Test 2</span><span class="class-title-line">Speaking: Tasks 5–8 Review</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Complete Writing Test 2</h5>
                        <p>Self-assessment.</p>
                        <a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_writing_t1_002.php" class="btn btn-primary" target="_blank" rel="noopener">Writing Task 1 Practice Test 2 <i class="bi bi-box-arrow-up-right ms-1"></i></a>
                        <a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_writing_t2_002.php" class="btn btn-primary" target="_blank" rel="noopener">Writing Task 2 Practice Test 2 <i class="bi bi-box-arrow-up-right ms-1"></i></a>
                    </div>
                    <div class="lesson-item">
                        <h5>Speaking: Tasks 5–8 Review</h5>
                        <p>Tasks 5–8 strategy review (persuasion, comparison, reasoning).</p>
                    </div>
                </div>
            <?php endif; ?>

            <div class="lesson-nav">
                <a href="class10.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class12.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
