...
<head>
    <meta charset="utf-8">
    <title>Complete Speaking Test 3 · Reading: Complex Passage Strategy — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complete Speaking Test 3 · Reading: Complex Passage Strategy</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 7</span><span class="class-chip">Class 14 of 16</span></div>
                    <h1 class="class-title"><span class="class-title-line">Complete Speaking Test 3</span><span class="class-title-line">Reading: Complex Passage Strategy</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Complete Speaking Test 3</h5>
                        <p>(full 8 tasks), detailed feedback.</p>
                        <a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_speaking_003.php" class="btn btn-primary btn-lg" target="_blank" rel="noopener"><i class="bi bi-box-arrow-up-right me-2"></i>Open Test</a>
                    </div>
                    <div class="lesson-item">
                        <h5>Reading: Complex Passage Strategy</h5>
                        <p>complex passage strategy.</p>
                    </div>
                </div>
            <?php endif; ?>

            <div class="lesson-nav">
                <a href="class13.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class15.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
