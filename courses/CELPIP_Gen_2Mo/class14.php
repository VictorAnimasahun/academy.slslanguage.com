...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 7 — Reading + Speaking Focus &nbsp;·&nbsp; Class 14 of 16</p>
            <h1 class="mb-3">
                <i class="bi bi-mic me-2" style="color:#0b77ff;"></i>
                Complete Speaking Test 3 + Reading: Complex Passage Strategy
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><ul><li>Speaking: Complete Speaking Test 3 (full 8 tasks), detailed feedback.</li><li>Reading: complex passage strategy.</li></ul></div>
