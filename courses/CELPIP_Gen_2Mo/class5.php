...
<head>
    <meta charset="utf-8">
    <title>Complete Writing Test 1 + Listening: Parts 1–2 Overview — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Complete Writing Test 1 + Listening: Parts 1–2 Overview</li>
                </ol>
            </nav>

            <p class="text-muted small mb-1">Week 3 — Writing + Listening Focus &nbsp;·&nbsp; Class 5 of 16</p>
            <h1 class="mb-3">
                <i class="bi bi-pencil-square me-2" style="color:#0b77ff;"></i>
                Complete Writing Test 1 + Listening: Parts 1–2 Overview
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><ul><li>Writing: Complete Writing Test 1 (Task 1 &amp; 2, timed), self-assessment.</li><li>Listening: Parts 1–2 overview and key question types.</li></ul></div>
                <div class="d-flex flex-wrap gap-2"><a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_writing_t1_001.php" class="btn btn-primary" target="_blank" rel="noopener">Writing Task 1 Practice Test 1 <i class="bi bi-box-arrow-up-right ms-1"></i></a><a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_writing_t2_001.php" class="btn btn-primary" target="_blank" rel="noopener">Writing Task 2 Practice Test 1 <i class="bi bi-box-arrow-up-right ms-1"></i></a></div>
