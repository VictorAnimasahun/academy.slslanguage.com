        ...
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    ...
                    <h1 class="class-title"><span class="class-title-line">Complete Writing Test 1</span><span class="class-title-line">Listening: Parts 1–2 Overview</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Complete Writing Test 1</h5>
                        <p>(Task 1 &amp; 2, timed), self-assessment.</p>
                        <a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_writing_t1_001.php" class="btn btn-primary" target="_blank" rel="noopener">Writing Task 1 Practice Test 1 <i class="bi bi-box-arrow-up-right ms-1"></i></a>
                        <a href="<?= ACADEMY_URL ?>resources/practice_tests/celpip_writing_t2_001.php" class="btn btn-primary" target="_blank" rel="noopener">Writing Task 2 Practice Test 1 <i class="bi bi-box-arrow-up-right ms-1"></i></a>
                    </div>
                    <div class="lesson-item">
                        <h5>Listening: Parts 1–2 Overview</h5>
                        <p>Parts 1–2 overview and key question types.</p>
                    </div>
                </div>
            <?php endif; ?>
