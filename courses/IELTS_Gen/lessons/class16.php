...
<nav aria-label="breadcrumb" class="mb-3"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../../courses_catalogue.php" class="text-decoration-none">Courses</a></li><li class="breadcrumb-item"><a href="<?= htmlspecialchars($back['url']) ?>" class="text-decoration-none"><?= htmlspecialchars($back['name']) ?></a></li><li class="breadcrumb-item active">Class 16 — Mock Test 2</li></ol></nav>
<?php render_upgrade_prompt('advanced','Class 16: Mock Test 2 — Full Timed Exam'); ?>
...
$__pacingBlockers = getIncompletePriorPacingItems($db, (int)$_SESSION['user_id'], 9, 78);
if ($__pacingBlockers) { ?>
...
<?php include INCLUDES_PATH.'/mobile_header.php'; ?><div class="mobile-overlay" id="mobileOverlay"></div><?php include INCLUDES_PATH.'/navbar.php'; ?>
<main class="main-wrapper"><div class="course-card">
<nav aria-label="breadcrumb" class="mb-3"><ol class="breadcrumb"><li class="breadcrumb-item"><a href="../../courses_catalogue.php" class="text-decoration-none">Courses</a></li><li class="breadcrumb-item"><a href="<?= htmlspecialchars($back['url']) ?>" class="text-decoration-none"><?= htmlspecialchars($back['name']) ?></a></li><li class="breadcrumb-item active">Class 16</li></ol></nav>
...
<head>
    <meta charset="utf-8">
    <title>IELTS General Masterclass — Class 16: Mock Test 2</title>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            <nav aria-label="breadcrumb" class="mb-3"><ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">Class 16 — Mock Test 2</li>
            </ol></nav>

            <h1 class="mb-3">
                <i class="bi bi-journal-richtext me-2" style="color:#6366f1;"></i>
            ...
            <div class="highlight-box" style="background:#fffbeb;border-color:#f59e0b;">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    <div>
                        ...
                        <span class="badge-custom">Class 16 of 24</span>
            ...
            <div class="content-section">
                ...
                <p class="lead">
                    This is your second full timed mock examination. Conditions must replicate the real exam:
                    no pausing, no mid-test answer checking, no looking anything up until all four skills are done.
                </p>
                <p>
                    Mock Test 2 measures progress since Mock Test 1. If you have been applying the strategies
                    from Classes 9–15, you should see movement in your band score estimates — especially in
                    Listening and Reading, where the techniques are most immediately testable.
                </p>
            </div>
            ...
            <div class="content-section">
                ...
                <div class="info-grid">
                    <div class="info-card">
                        ...
                        <p class="mb-0 text-muted small">Focus: spot distractors. Do not write until the speaker has moved on.</p>
                    </div>
                    <div class="info-card">
                        ...
                        <p class="mb-0 text-muted small">Focus: keyword underlining, never blank — always guess.</p>
                    </div>
                    <div class="info-card">
                        <h4><i class="bi bi-pencil me-2"></i>Writing</h4>
                        <p class="mb-1"><strong>Duration:</strong> 60 minutes</p>
                        <p class="mb-1"><strong>Format:</strong> Task 1 (20 min) + Task 2 (40 min)</p>
                        <p class="mb-0 text-muted small">Focus: Task 2 — identify question type before you write a single word.</p>
                    </div>
                    <div class="info-card">
                        ...
                        <p class="mb-0 text-muted small">Focus: Part 3 — state a view, give a reason, give an example.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="highlight-box" style="background:#eff6ff;border-color:#3b82f6;">
                ...
                <ul class="mb-0">
                    ...
                    <li>Band score estimates will be compared with Mock Test 1 results — measure your progress.</li>
                    <li>Your Month 3 targeted improvement plan will prioritise the skills where the gap between current band and target is largest.</li>
                    <li>If your Writing score has not improved, your tutor will focus Month 3 on Task 2 structure and lexical range.</li>
                </ul>
            </div>

            <div class="content-section">
                <h2>Month 2 — What We Covered</h2>
                <p>Before the mock, take 5 minutes to review the Month 2 skill additions:</p>
                <ul class="custom-list">
                    <li><strong>Listening:</strong> Matching headings in Listening, plan labelling (Parts 3 &amp; 4), note/table/flowchart completion, distractor identification, synonym recognition</li>
                    <li><strong>Reading:</strong> Matching headings, MCQ elimination technique, keyword underlining, sentence completion, summary completion</li>
                    <li><strong>Writing Task 1:</strong> Semi-formal and informal letters, cohesive devices by register</li>
                    <li><strong>Writing Task 2:</strong> Five question types, two-sentence introduction, four marking criteria, PEEL body paragraphs (preview — Class 18)</li>
                    <li><strong>Speaking:</strong> Part 2 long turn with 1-minute planning, Part 3 hedging phrases, five-step critical thinking framework</li>
                </ul>
            </div>

            <div class="action-buttons">
                <a href="class15.php" class="btn btn-outline-secondary"><i class="bi bi-arrow-left-circle me-2"></i>Class 15</a>
                <a href="class17.php" class="btn btn-primary btn-lg"><i class="bi bi-play-circle me-2"></i>Start Month 3 — Class 17</a>
    ...
    <aside class="advert-sidebar">
        <div class="course-card" style="background:linear-gradient(135deg,#6366f1 0%,#0b77ff 100%);color:white;">
            ...
            <div class="d-grid gap-1">
                ...
                <span class="btn btn-warning btn-sm disabled fw-bold text-dark">Mock Test 2 — Here</span>
                <a href="class17.php" class="btn btn-outline-light btn-sm">Month 3: Class 17 →</a>
