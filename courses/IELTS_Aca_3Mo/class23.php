...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 23, 'fluent');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Mock Test 3 (Final Assessment) — Full Timed (L, R, W, S) — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Mock Test 3 (Final Assessment) — Full Timed (L, R, W, S)</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 12</span><span class="class-chip">Class 23 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Mock Test 3 (Final Assessment) — Full Timed (L, R, W, S)</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_3Mo', 23); ?>
            ...
            <div class="lesson-nav">
                <a href="class22.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class24.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
