...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 12, 'advanced');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 6</span><span class="class-chip">Class 12 of 24</span></div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_3Mo', 12); ?>
