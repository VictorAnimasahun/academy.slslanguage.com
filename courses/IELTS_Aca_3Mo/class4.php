...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 2 — Reading & Speaking Foundations &nbsp;·&nbsp; Class 4 of 24</p>
            <h1 class="mb-3">
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><h5>Speaking</h5><ul><li>Complete Speaking Test 1 (Parts 1-3, recorded)</li><li>Immediate feedback</li></ul><h5>Writing</h5><ul><li>Comparative/superlative structures for Task 1</li><li>TEE body paragraph structure</li></ul></div>
