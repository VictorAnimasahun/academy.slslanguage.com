...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 4, 'intermediate');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Speaking Test 1 · Comparative Structures & TEE — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Speaking Test 1 · Comparative Structures & TEE</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 2</span><span class="class-chip">Class 4 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Speaking Test 1</span><span class="class-title-line">Comparative Structures &amp; TEE</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Speaking Test 1 <?= lesson_kind_badge($db, 'IELTS_Aca_3Mo', 4, 'Speaking Test 1') ?></h5>
                    ...
                    <div class="lesson-item">
                        <h5>Comparative Structures &amp; TEE <?= lesson_kind_badge($db, 'IELTS_Aca_3Mo', 4, 'Comparative Structures &amp; TEE') ?></h5>
                        <ul><li>Comparative/superlative structures for Task 1</li><li>TEE body paragraph structure</li></ul>
                        <?= lesson_part_button($db, 'IELTS_Aca_3Mo', 4, 'Comparative Structures &amp; TEE') ?>
                    </div>
                </div>
            <?php endif; ?>

            <div class="lesson-nav">
                <a href="class3.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class5.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
