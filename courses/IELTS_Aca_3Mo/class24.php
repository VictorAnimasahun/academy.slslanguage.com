...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 24, 'fluent');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Final Review · Test-Day Coaching — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Final Review · Test-Day Coaching</li>
                </ol>
            </nav>

            <div class="class-head">
                <div class="class-head-icon"><i class="bi bi-flag"></i></div>
                <div>
                    <div class="class-chips"><span class="class-chip">Week 12</span><span class="class-chip">Class 24 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Final Review</span><span class="class-title-line">Test-Day Coaching</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_3Mo', 24); ?>
            ...
            <div class="lesson-nav">
                <a href="class23.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="course_overview.php" class="btn btn-success flex-fill"><i class="bi bi-flag-fill me-1"></i>Finish — Back to Course Overview</a>
            </div>
