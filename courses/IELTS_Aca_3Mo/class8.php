...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 8, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 4</span><span class="class-chip">Class 8 of 24</span></div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Speaking Test 2 <?= lesson_kind_badge($db, 'IELTS_Aca_3Mo', 8, 'Speaking Test 2') ?></h5>
                    ...
                    <div class="lesson-item">
                        <h5>Task 1 Report Structuring <?= lesson_kind_badge($db, 'IELTS_Aca_3Mo', 8, 'Task 1 Report Structuring') ?></h5>
                        <ul><li>Structuring Task 1 reports</li><li>Academic tone and grammar correction</li></ul>
                        <?= lesson_part_button($db, 'IELTS_Aca_3Mo', 8, 'Task 1 Report Structuring') ?>
                    </div>
                </div>
            <?php endif; ?>
