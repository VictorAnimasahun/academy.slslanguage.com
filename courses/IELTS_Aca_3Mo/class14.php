...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 14, 'advanced');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 7</span><span class="class-chip">Class 14 of 24</span></div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    ...
                    <div class="lesson-item">
                        ...
                        <?= lesson_part_button($db, 'IELTS_Aca_3Mo', 14, 'Complex Passage Strategy') ?>
                    </div>
                </div>
            <?php endif; ?>
