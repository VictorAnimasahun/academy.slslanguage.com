...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 21, 'fluent');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Writing Test 4 · Final Writing Polish — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Writing Test 4 · Final Writing Polish</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 11</span><span class="class-chip">Class 21 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Writing Test 4</span><span class="class-title-line">Final Writing Polish</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_3Mo', 21); ?>
            ...
            <div class="lesson-nav">
                <a href="class20.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class22.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
