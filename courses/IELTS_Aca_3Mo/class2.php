...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 2, 'intermediate');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Listening Test 1 · Writing Task Overview — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Listening Test 1 · Writing Task Overview</li>
                </ol>
            </nav>

            <div class="class-head">
                <div class="class-head-icon"><i class="bi bi-headphones"></i></div>
                <div>
                    <div class="class-chips"><span class="class-chip">Week 1</span><span class="class-chip">Class 2 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Listening Test 1</span><span class="class-title-line">Writing Task Overview</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Listening Test 1 <?= lesson_kind_badge($db, 'IELTS_Aca_3Mo', 2, 'Listening Test 1') ?></h5>
                        <ul><li>Complete Listening Test 1 (full-length)</li><li>Answer review</li></ul>
                        <a href="<?= ACADEMY_URL ?>resources/practice_tests/ielts_listening_001.php" class="btn btn-primary btn-lg" target="_blank" rel="noopener">
                    <i class="bi bi-box-arrow-up-right me-2"></i>Open Test
                </a>
                    </div>
                    <div class="lesson-item">
                        <h5>Writing Task Overview <?= lesson_kind_badge($db, 'IELTS_Aca_3Mo', 2, 'Writing Task Overview') ?></h5>
                        <ul><li>Task 1 &amp; Task 2 overview</li><li>Assessment criteria</li><li>Band 5 vs. Band 7+ sample analysis</li></ul>
                        <?= lesson_part_button($db, 'IELTS_Aca_3Mo', 2, 'Writing Task Overview') ?>
                    </div>
                </div>
            <?php endif; ?>

            <div class="lesson-nav">
                <a href="class1.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class3.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
