...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 16, 'advanced');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Mock Test 2 — Full Timed (L, R, W, S) — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Mock Test 2 — Full Timed (L, R, W, S)</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 8</span><span class="class-chip">Class 16 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Mock Test 2 — Full Timed (L, R, W, S)</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_3Mo', 16); ?>
            ...
            <div class="lesson-nav">
                ...
                <a href="class17.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
