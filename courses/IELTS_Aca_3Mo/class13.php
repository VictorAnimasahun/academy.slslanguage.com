...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 13, 'advanced');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Reading Test 3 · Listening Fast-Audio Drills — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Reading Test 3 · Listening Fast-Audio Drills</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 7</span><span class="class-chip">Class 13 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Reading Test 3</span><span class="class-title-line">Listening Fast-Audio Drills</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_3Mo', 13); ?>
