...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 10, 'advanced');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 5</span><span class="class-chip">Class 10 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Mock 1 Review</span><span class="class-title-line">Reading Time-Management</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_3Mo', 10); ?>
            ...
            <div class="lesson-nav">
                <a href="class9.php" class="btn btn-outline-secondary flex-fill text-truncate"><i class="bi bi-arrow-left me-1"></i>Previous Class</a>
                <a href="class11.php" class="btn btn-primary flex-fill text-truncate">Next Class<i class="bi bi-arrow-right ms-1"></i></a>
            </div>
