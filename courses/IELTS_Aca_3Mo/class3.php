...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 3, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 2</span><span class="class-chip">Class 3 of 24</span></div>
