...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 2 — Reading & Speaking Foundations &nbsp;·&nbsp; Class 3 of 24</p>
            <h1 class="mb-3">
                <i class="bi bi-book me-2" style="color:#0b77ff;"></i>
                Reading Test 1 + Trend Vocabulary & Paraphrasing
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><h5>Reading</h5><ul><li>Complete Reading Test 1 (full-length, 3 passages)</li><li>Answer review</li></ul><h5>Writing</h5><ul><li>Trend vocabulary and sentence structures</li><li>Paraphrasing questions and thesis statements</li></ul></div>
