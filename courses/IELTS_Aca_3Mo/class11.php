...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 11, 'advanced');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Writing Test 2 (Timed) · Speaking Part 2 Drilling — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Writing Test 2 (Timed) · Speaking Part 2 Drilling</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 6</span><span class="class-chip">Class 11 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Writing Test 2 (Timed)</span><span class="class-title-line">Speaking Part 2 Drilling</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_3Mo', 11); ?>
