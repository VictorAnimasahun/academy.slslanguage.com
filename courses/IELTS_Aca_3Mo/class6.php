...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 6, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 3</span><span class="class-chip">Class 6 of 24</span></div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Listening Test 2 <?= lesson_kind_badge($db, 'IELTS_Aca_3Mo', 6, 'Listening Test 2') ?></h5>
