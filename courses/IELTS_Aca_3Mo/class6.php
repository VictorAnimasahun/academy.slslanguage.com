...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 3 — Writing Test 1 & Listening Test 2 &nbsp;·&nbsp; Class 6 of 24</p>
            <h1 class="mb-3">
                <i class="bi bi-headphones me-2" style="color:#0b77ff;"></i>
                Listening Test 2 + Map Description & Passive Voice
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><h5>Listening</h5><ul><li>Complete Listening Test 2</li><li>Answer review focused on weak section types</li></ul><h5>Writing</h5><ul><li>Map description phrases and passive voice</li><li>Strengthening weak arguments</li></ul></div>
