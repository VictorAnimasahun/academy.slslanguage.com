...
$minTier = lesson_min_tier($db, 'IELTS_Aca_3Mo', 20, 'fluent');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 10</span><span class="class-chip">Class 20 of 24</span></div>
                    <h1 class="class-title"><span class="class-title-line">Speaking Test 4</span><span class="class-title-line">Advanced Speaking</span></h1>
                </div>
            </div>
