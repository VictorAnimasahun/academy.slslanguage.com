...
$minTier = lesson_min_tier($db, 'IELTS_Aca_2Mo', 15, 'advanced');   // from the database (lessons.min_tier), not typed here
        ...
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    ...
                    <h1 class="class-title"><span class="class-title-line">Writing Test 3 (Timed)</span><span class="class-title-line">Final Self-Assessment</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_2Mo', 15); ?>
