...
$minTier = lesson_min_tier($db, 'IELTS_Aca_2Mo', 12, 'advanced');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Listening Test 3 · Speaking Part 3 Drilling — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Listening Test 3 · Speaking Part 3 Drilling</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    ...
                    <h1 class="class-title"><span class="class-title-line">Listening Test 3</span><span class="class-title-line">Speaking Part 3 Drilling</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_2Mo', 12); ?>
