...
$minTier = lesson_min_tier($db, 'IELTS_Aca_2Mo', 3, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 2</span><span class="class-chip">Class 3 of 16</span></div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Reading Test 1 <?= lesson_kind_badge($db, 'IELTS_Aca_2Mo', 3, 'Reading Test 1') ?></h5>
                    ...
                    <div class="lesson-item">
                        <h5>Trend Vocabulary &amp; Paraphrasing <?= lesson_kind_badge($db, 'IELTS_Aca_2Mo', 3, 'Trend Vocabulary &amp; Paraphrasing') ?></h5>
                        ...
                        <?= lesson_part_button($db, 'IELTS_Aca_2Mo', 3, 'Trend Vocabulary &amp; Paraphrasing') ?>
                    </div>
                </div>
            <?php endif; ?>
