...
$minTier = lesson_min_tier($db, 'IELTS_Aca_2Mo', 11, 'advanced');   // from the database (lessons.min_tier), not typed here
...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <?php else: ?>
                <?php $__parts = lesson_class_parts_list($db, 'IELTS_Aca_2Mo', 11); ?>
