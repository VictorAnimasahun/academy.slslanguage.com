...
$minTier = lesson_min_tier($db, 'IELTS_Aca_2Mo', 6, 'intermediate');   // from the database (lessons.min_tier), not typed here
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="class-head">
                ...
                <div>
                    <div class="class-chips"><span class="class-chip">Week 3</span><span class="class-chip">Class 6 of 16</span></div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    ...
                    <div class="lesson-item">
                        ...
                        <?= lesson_part_button($db, 'IELTS_Aca_2Mo', 6, 'Map Description &amp; Passive Voice') ?>
                    </div>
                </div>
            <?php endif; ?>
