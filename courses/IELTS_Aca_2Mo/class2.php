...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 1 — Orientation, Diagnostic & Listening Start &nbsp;·&nbsp; Class 2 of 16</p>
            <h1 class="mb-3">
                <i class="bi bi-headphones me-2" style="color:#0b77ff;"></i>
                Listening Test 1 + Writing Task Overview
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><h5>Listening</h5><ul><li>Complete Listening Test 1 (full-length)</li><li>Answer review</li></ul><h5>Writing</h5><ul><li>Task 1 &amp; Task 2 overview — chart/graph/map/process types, essay types</li><li>Assessment criteria</li><li>Band 5 vs. Band 7+ sample analysis</li></ul></div>
