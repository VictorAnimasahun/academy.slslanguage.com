...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Week 7 — Reading Test 3 & Speaking Test 3 &nbsp;·&nbsp; Class 14 of 16</p>
            <h1 class="mb-3">
                <i class="bi bi-mic me-2" style="color:#0b77ff;"></i>
                Speaking Test 3 + Complex Passage Strategy
            </h1>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><h5>Speaking</h5><ul><li>Complete Speaking Test 3 (full 3-part simulation)</li><li>Detailed feedback across all 4 criteria</li></ul><h5>Reading</h5><ul><li>Complex passage strategy — long sentences, academic vocabulary, implied meaning</li><li>Timed practice</li></ul></div>
