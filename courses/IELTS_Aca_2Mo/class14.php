...
$minTier = lesson_min_tier($db, 'IELTS_Aca_2Mo', 14, 'advanced');   // from the database (lessons.min_tier), not typed here
...
<head>
    <meta charset="utf-8">
    <title>Speaking Test 3 · Complex Passage Strategy — <?= htmlspecialchars($course['title']) ?></title>
        ...
        <div class="course-card">
            ...
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Speaking Test 3 · Complex Passage Strategy</li>
                </ol>
            </nav>
            ...
            <div class="class-head">
                ...
                <div>
                    ...
                    <h1 class="class-title"><span class="class-title-line">Speaking Test 3</span><span class="class-title-line">Complex Passage Strategy</span></h1>
                </div>
            </div>
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4">
                    <div class="lesson-item">
                        <h5>Speaking Test 3 <?= lesson_kind_badge($db, 'IELTS_Aca_2Mo', 14, 'Speaking Test 3') ?></h5>
