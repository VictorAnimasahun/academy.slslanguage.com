...
<body>
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <p class="text-muted small mb-1">Month 1 — IELTS Academic Foundations &nbsp;·&nbsp; Class 8 of 16</p>
            <h1 class="mb-3">
            ...
            <?php else: ?>
                ...
                <div class="lesson-content mb-4"><h5>Speaking</h5><ul><li>Complete Speaking Test 2 (Parts 1-3, recorded)</li><li>Feedback on lexical resource and grammar range</li></ul><h5>Writing</h5><ul><li>Structuring Task 1 reports — Introduction, Overview, Key Features, Details</li><li>Academic tone and grammar correction</li><li>Exercises on both</li></ul></div>
