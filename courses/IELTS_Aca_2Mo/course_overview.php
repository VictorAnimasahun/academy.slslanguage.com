    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="highlight-box">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <?php endif; ?>
                        <a href="<?= ACADEMY_URL ?>courses/IELTS_Aca_Crash/intro.php?from=IELTS_Aca_2Mo" class="btn btn-outline-primary btn-sm">
            ...
            <div class="content-section">
                ...
                <div class="info-grid">
                    <div class="info-card"><h4><i class="bi bi-play-circle me-2"></i>Lesson Videos</h4><p class="mb-0">Curated IELTS Academic video lessons for every class, covering Reading, Writing, Listening, and Speaking.</p></div>
            ...
            <div class="action-buttons">
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Aca_Crash/intro.php?from=IELTS_Aca_2Mo" class="btn btn-primary btn-lg">
    ...
    <aside class="advert-sidebar">
        <div class="course-card" style="background:linear-gradient(135deg,#6366f1 0%,#0b77ff 100%);color:white;">
            ...
            <div class="d-grid gap-1">
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Aca_Crash/intro.php?from=IELTS_Aca_2Mo" class="btn btn-light btn-sm">Class 1 — Free Preview</a>
                <?php if ($student_tier_level >= 2): ?>
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Aca_Crash/mock_exam.php?from=IELTS_Aca_2Mo" class="btn btn-outline-light btn-sm">Mock Exam 1</a>
                <?php endif; ?>
                <?php if ($student_tier_level < 2): ?>
