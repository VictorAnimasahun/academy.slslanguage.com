...
// Load course
$stmt = $db->prepare("SELECT * FROM courses WHERE folder_name = 'IELTS_Gen_Mst' LIMIT 1");
$stmt->execute();
            ...
            <div class="highlight-box">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <?php endif; ?>
                        <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/intro.php?from=IELTS_Gen_Mst" class="btn btn-outline-primary btn-sm">
                        ...
                        <div id="<?= $collapse_id ?>"
                            ...
                            <div class="accordion-body p-0">
                                ...
                                <?php foreach ($module['lessons'] as $idx => $lesson):
                                    ...
                                    $file_path  = $lesson['file_path'] ?? 'intro.php';
                                ?>
                                <li class="d-flex align-items-center justify-content-between px-3 py-2
                                           <?= $idx < count($module['lessons']) - 1 ? 'border-bottom' : '' ?>"
                                    style="<?= $is_mock ? 'background:#fffbeb;' : '' ?>">

                                    <div class="d-flex align-items-center gap-2">
                                        <?php if ($can_access && $file_path): ?>
                                            <a href="<?= ACADEMY_URL . htmlspecialchars($file_path) ?>?from=IELTS_Gen_Mst"
            ...
            <div class="content-section">
                ...
                <div class="info-grid">
                    ...
                    <div class="info-card">
                        ...
                        <p class="mb-0">A consolidation quiz after every class — 10 questions to lock in the strategies.</p>
                    </div>
                    <div class="info-card">
                    ...
                    <div class="info-card">
                        ...
                        <p class="mb-0">4 full practice test sets (16 sections) spread across the 21 teaching classes.</p>
                    </div>
                    <div class="info-card">
                    ...
                    <div class="info-card">
                        ...
                        <p class="mb-0">Certificate of completion awarded upon finishing Class 24.</p>
                    </div>
                </div>
            </div>

            <div class="action-buttons">
                <a href="<?= ACADEMY_URL ?>courses/IELTS_Gen/lessons/intro.php?from=IELTS_Gen_Mst" class="btn btn-primary btn-lg">
