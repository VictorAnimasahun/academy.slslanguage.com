...
$stmt = $db->prepare("SELECT * FROM courses WHERE folder_name = 'CELPIP_Gen_1Mo' LIMIT 1");
$stmt->execute();
    ...
    <main class="main-wrapper">
        <div class="course-card">
            ...
            <div class="highlight-box">
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <?php endif; ?>
                        <a href="<?= ACADEMY_URL ?>courses/CELPIP_intro/intro.php?from=CELPIP_Gen_1Mo" class="btn btn-outline-primary btn-sm">
                                ...
                                <li class="d-flex align-items-center justify-content-between px-3 py-2 <?= $idx < count($module['lessons'])-1 ? 'border-bottom' : '' ?>"
                                    ...
                                    <div class="d-flex align-items-center gap-2">
                                        <?php if ($can_access && $file_path): ?>
                                            <a href="<?= ACADEMY_URL . htmlspecialchars($file_path) ?>?from=CELPIP_Gen_1Mo" class="text-decoration-none text-dark d-flex align-items-center gap-2">
            ...
            <div class="content-section">
                ...
                <div class="info-grid">
                    <div class="info-card"><h4><i class="bi bi-play-circle me-2"></i>Lesson Videos</h4><p class="mb-0">Curated CELPIP-specific video lessons for every class, mapped to each skill area.</p></div>
                    ...
                    <div class="info-card"><h4><i class="bi bi-house-heart me-2"></i>Take-Home Tasks</h4><p class="mb-0">One practical task per class — email drafts, listening notes, or speaking recordings to self-review.</p></div>
                    <div class="info-card"><h4><i class="bi bi-clipboard-check me-2"></i>1 Practice Test Set</h4><p class="mb-0">A full CELPIP practice test set across all four skills, spread throughout the teaching classes.</p></div>
                    <div class="info-card"><h4><i class="bi bi-journal-richtext me-2"></i>1 Full Mock Exam</h4><p class="mb-0">End-of-month full timed mock exam with written feedback and a CLB band score estimate.</p></div>
                    <div class="info-card"><h4><i class="bi bi-arrow-up-circle me-2"></i>Upgrade Anytime</h4><p class="mb-0">Upgrade to the 2-Month or 3-Month plan at any time — your progress carries over.</p></div>
                </div>
            </div>

            <div class="action-buttons">
                <a href="<?= ACADEMY_URL ?>courses/CELPIP_intro/intro.php?from=CELPIP_Gen_1Mo" class="btn btn-primary btn-lg">
    ...
    <aside class="advert-sidebar">
        <div class="course-card" style="background:linear-gradient(135deg,#0b77ff 0%,#6366f1 100%);color:white;">
            ...
            <div class="d-grid gap-1">
                <a href="<?= ACADEMY_URL ?>courses/CELPIP_intro/intro.php?from=CELPIP_Gen_1Mo" class="btn btn-light btn-sm">Class 1 — Free Preview</a>
                <?php if ($student_tier_level >= 2): ?>
                <a href="<?= ACADEMY_URL ?>courses/CELPIP_intro/celpip_mini_mock.php?from=CELPIP_Gen_1Mo" class="btn btn-outline-light btn-sm">Mock Exam</a>
                <?php else: ?>
