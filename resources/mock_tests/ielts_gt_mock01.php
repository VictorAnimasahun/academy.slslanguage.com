...
$mockCode = $_GET['code'] ?? 'IELTS_GT_MOCK01';
                ...
                <div class="section-content">
                    ...
                    <div class="part-tabs-bar">
                        <div class="part-tabs-scrollable">
                            <?php foreach ($parts as $pNum => $p): [$f, $l] = $partRanges[$pNum]; ?>
                    ...
                    <div class="part-panel <?= $pNum === 1 ? 'active' : '' ?>" id="panel-<?= $pNum ?>">
                        ...
                        <?php /* Worksheet image (if configured) */
                        ...
                        <div class="section-block">
                            ...
                            elseif ($sec['type'] === 'multiple_choice'): ?>
                                <?php if (!empty($sec['legend'])): ?>
                                <div class="mc-legend">
                                    <?php foreach ($sec['legend'] as $letter => $desc): ?>
                                ...
                                <?php foreach ($sec['questions'] as $mcq):
                                ...
                                <div class="mc-question">
                                    ...
                                    <?php foreach ($opts as $letter => $optText): ?>
                        ...
                        <?php [$pFirst, $pLast] = $partRanges[$pNum]; $pTotal = $pLast - $pFirst + 1; ?>
                        <div class="part-minibar">
                            <div class="minibar-inner">
                                <span class="minibar-tag">Progress</span>
                                <div class="q-bubbles">
                                    <?php for ($qi = $pFirst; $qi <= $pLast; $qi++): ?>
                    ...
                    <div class="r-panel" id="rpanel-3">
                        <div class="reading-split">
                            ...
                            <div class="reading-questions">
                                ...
                                <?php foreach (['A'=>28,'B'=>29,'C'=>30,'D'=>31,'E'=>32,'F'=>33,'G'=>34] as $para => $qn): ?>
                                <div class="r-match-q">
                                    <span class="q-badge"><?= $qn ?></span>
                                    <span class="r-match-q-text">Paragraph <?= $para ?></span>
                                    <select class="match-select" id="rsel-<?= $qn ?>" onchange="readingHandleInput(<?= $qn ?>,this.value)">
                                        <option value="">—</option>
                                        <?php foreach (array_keys($headings) as $num): ?>
                                ...
                                <div class="mc-question">
                                    ...
                                    <?php foreach ($mc['opts'] as $letter => $text): ?>
                                    <label class="mc-option">
