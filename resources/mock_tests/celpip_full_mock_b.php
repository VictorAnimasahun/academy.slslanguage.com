...
if ($existing && $action === '') {
    ...
    <head>
        ...
        <title>Resume or Start Over — CELPIP Full Mock B | EduHub</title>
                ...
                <div style="max-width:560px;margin:2rem auto;">
                    <div class="card border-0 shadow-sm rounded-4">
                        <div class="card-body p-4 text-center">
                            ...
                            <p class="text-muted mb-4">You started CELPIP Full Mock B earlier but haven't finished it. Would you like to pick up where you left off, or start over from Listening?</p>
