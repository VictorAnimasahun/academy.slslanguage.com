...
// Mock 4 — audio/asset path derives from the session's mock_code automatically
$mockCode      = $session['mock_code']; // e.g. IELTS_FULL_MOCK_004
    ...
    <main class="content p-3">
        ...
        <div class="sticky-header">
            ...
            <div style="background:#1e1b4b;color:#c7d2fe;padding:.6rem 1.25rem;border-radius:8px;margin-bottom:.5rem;display:flex;align-items:center;gap:1.5rem;font-size:.82rem;font-weight:600;">
                ...
                <a href="full_mock_004_listening.php?session_id=<?= $session_id ?>" style="color:#c7d2fe;text-decoration:none;border-bottom:2px solid #6366f1;padding-bottom:2px;">🎧 Listening</a>
                <a href="full_mock_004_reading.php?session_id=<?= $session_id ?>"   style="color:#a5b4fc;text-decoration:none;">📖 Reading</a>
