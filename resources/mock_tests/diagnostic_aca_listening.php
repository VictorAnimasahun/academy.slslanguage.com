...
$audioBase      = ACADEMY_URL . 'assets/audio/IELTS_ACA_DIAGNOSTIC/';
$mapImgUrl      = null; // no diagram section in the diagnostic
$DURATION_SECS  = 15 * 60; // short audio + transfer time
?>
<!DOCTYPE html>
<html lang="en">
<head>
