...
// with the actual content for mock test: IELTS_GT_MOCK04
...
$mockCode = $_GET['code'] ?? 'IELTS_GT_MOCK04';
...
<head>
    ...
    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 include INCLUDES_PATH . '/navbar_styles.php'; ?>
...
<body>
    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 include INCLUDES_PATH . '/mobile_header.php'; ?>
    <div class="mobile-overlay" id="mobileOverlay"></div>
    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 include INCLUDES_PATH . '/navbar.php'; ?>
                ...
                <div class="section-content">
                    ...
                    <div class="part-tabs-bar">
                        <div class="part-tabs-scrollable">
                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($parts as $pNum => $p): [$f, $l] = $partRanges[$pNum]; ?>
                            ...
                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 endforeach; ?>
                        </div>
                    ...
                    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($parts as $pNum => $p): ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04
                        ...
                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 /* Worksheet image (if configured) */
                        ...
                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 endif; ?>

                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($p['sections'] as $si => $sec): ?>
                        <div class="section-block">

                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 if ($si === 0 && !empty($p['preview_s'])): ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04 endif; ?>
                            ...
                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 /* ── FORM FILL ── */
                            if ($sec['type'] === 'form_fill'): ?>
                                <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 if (!empty($sec['form_title'])): ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04 endif; ?>
                                <table class="ff-table">
                                    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($sec['rows'] as $row): ?>
                                    <tr>
                                        <td><?= htmlspecialchars($row['label']) ?></td>
                                        <td>
                                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 if ($row['q'] === null): ?>
                                            <?= htmlspecialchars($row['after']) ?>
                                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 else: ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04 endforeach; ?>
                            ...
                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 /* ── MULTIPLE CHOICE ── */
                            elseif ($sec['type'] === 'multiple_choice'): ?>
                                <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 if (!empty($sec['legend'])): ?>
                                <div class="mc-legend">
                                    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($sec['legend'] as $letter => $desc): ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04 endif; ?>
                                ...
                                <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($sec['questions'] as $mcq):
                                ...
                                <div class="mc-question">
                                    ...
                                    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($opts as $letter => $optText): ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04 endforeach; ?>
                            ...
                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 /* ── SHORT ANSWER GROUPED ── */
                            elseif ($sec['type'] === 'short_answer_grouped'): ?>
                                <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($sec['groups'] as $group): ?>
                                <div class="sa-group">
                                    <div class="sa-group-prompt"><?= $group['prompt'] ?></div>
                                    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($group['questions'] as $sq): ?>
                                    <div class="sa-item">
...
// with the actual content for mock test: IELTS_GT_MOCK04 endforeach; ?>
                        ...
                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 [$pFirst, $pLast] = $partRanges[$pNum]; $pTotal = $pLast - $pFirst + 1; ?>
                        <div class="part-minibar">
                            <div class="minibar-inner">
                                ...
                                <div class="q-bubbles">
                                    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 for ($qi = $pFirst; $qi <= $pLast; $qi++): ?>
                                    <div class="q-bubble" id="bubble-<?= $qi ?>"><?= $qi ?></div>
                                    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 endfor; ?>
                                </div>
                            </div>
...
// with the actual content for mock test: IELTS_GT_MOCK04
                                ...
                                <div class="r-match-q">
                                    ...
                                    <select class="match-select" id="rsel-<?= $qn ?>" onchange="readingHandleInput(<?= $qn ?>, this.value)">
                                        ...
                                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach (['A','B','C','D','E'] as $l): ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04
                                ...
                                <div class="tfng-q">
                                    ...
                                    <div class="tfng-options">
                                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach (['TRUE','FALSE','NOT GIVEN'] as $opt): ?>
                                ...
                                <div class="r-minibar">
                                    <div class="r-minibar-inner">
                                        ...
                                        <div class="q-bubbles">
                                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 for ($qi=1; $qi<=14; $qi++): ?>
                                ...
                                <div class="r-minibar">
                                    <div class="r-minibar-inner">
                                        ...
                                        <div class="q-bubbles">
                                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 for ($qi=15; $qi<=27; $qi++): ?>
                                            <div class="q-bubble" id="rbubble-<?= $qi ?>"><?= $qi ?></div>
                                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 endfor; ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04 endforeach; ?>
                                ...
                                <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach (['A'=>28,'B'=>29,'C'=>30,'D'=>31,'E'=>32,'F'=>33,'G'=>34] as $para => $qn): ?>
                                <div class="r-match-q">
                                    <span class="q-badge"><?= $qn ?></span>
                                    ...
                                    <select class="match-select" id="rsel-<?= $qn ?>" onchange="readingHandleInput(<?= $qn ?>,this.value)">
                                        ...
                                        <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach (array_keys($headings) as $num): ?>
...
// with the actual content for mock test: IELTS_GT_MOCK04
                                ...
                                <div class="mc-question">
                                    ...
                                    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 foreach ($mc['opts'] as $letter => $text): ?>
                                    <label class="mc-option">
                                ...
                                <div class="r-minibar">
                                    <div class="r-minibar-inner">
                                        ...
                                        <div class="q-bubbles">
                                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 for ($qi=28; $qi<=40; $qi++): ?>
                                            <div class="q-bubble" id="rbubble-<?= $qi ?>"><?= $qi ?></div>
                                            <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 endfor; ?>
    ...
    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 include INCLUDES_PATH . '/adverts.php'; ?>
    <audio id="audioEl" preload="auto"></audio>
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.3/dist/js/bootstrap.bundle.min.js"></script>
    <?php
// TODO: Replace all hardcoded listening data, correct answers, and reading passages below
// with the actual content for mock test: IELTS_GT_MOCK04 include INCLUDES_PATH . '/navbar_scripts.php'; ?>
