    ...
    <div class="main-wrapper flex-grow-1">
        ...
        <main class="content p-3">
            <div class="sticky-header">
                <?php if ($isAdmin): ?>
                <?php
                // See diagnostic_aca_listening.php's identical comment — this
                // page is shared by Academic and General Training diagnostics,
                // so the Reading nav link must resolve per-session, not hardcode.
