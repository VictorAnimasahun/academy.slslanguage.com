    ...
    'ielts' => [
        ...
        'items' => [
            'writing' => [
                'name' => 'Writing',
                'exercises' => [
                    ['title' => 'Letter Parts Sorter', 'description' => 'Identify intro, body, and conclusion', 'url' => 'letter_parts.php'],
                    //['title' => 'Sentence Sequencing', 'description' => 'Arrange sentences in logical order', 'url' => 'sentence_sequencing.php'],
...
<head>
	...
	<title>Exercises & Games | EduHub</title>
	...
	<main class="main-wrapper">
		<div class="exercises-container">
			...
			<div class="page-header">
				<h1><i class="bi bi-gamepad2"></i> Exercises & Games</h1>
				<p>Master your language skills with interactive exercises</p>
			</div>
