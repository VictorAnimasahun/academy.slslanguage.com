<?php
// CELPIP Speaking Practice 2 — transcribed from Downloads/CELPIP TASKS/Celpip Speaking/Speaking Test 2
...
$tasks = [
    1 => [
        ...
        'prep'   => 30,
        'speak'  => 90,
        'prompt' => "A friend is struggling to find a balance between work and personal life. What advice would you give them?",
    ],
    2 => [
        'title'  => 'Task 2: Talking about a Personal Experience',
        'prep'   => 30,
        'speak'  => 60,
        'prompt' => "Describe a time when you faced a significant challenge at work or school and how you overcame it.",
    ],
    3 => [
        'title'  => 'Task 3: Describing a Scene',
        'prep'   => 30,
        'speak'  => 60,
        'prompt' => "Describe what is happening in the picture below as well as you can. The person with whom you are speaking cannot see the picture.",
        'image'  => 'scene.jpg',
    ],
    4 => [
    ...
    5 => [
        ...
        'prep'   => 60,
        'speak'  => 60,
        'prompt' => "Your friend is debating between buying a used car or leasing a new one. Compare both options and persuade them to choose one.",
    ],
    6 => [
        'title'  => 'Task 6: Dealing with a Difficult Situation',
        'prep'   => 60,
        'speak'  => 60,
        'prompt' => "You were given extra responsibilities at work, but you feel overwhelmed. How would you handle the situation?",
    ],
    7 => [
        'title'  => 'Task 7: Expressing Opinions',
        'prep'   => 30,
        'speak'  => 90,
        'prompt' => "Do you think social media has a positive or negative impact on society? Why?",
    ],
    8 => [
...
<head>
    ...
    <title>CELPIP Speaking Practice Test 2 – EduHub</title>
                ...
                <?php if (!empty($task['image'])): ?>
                    <div class="speaking-content-row">
                        <div class="speaking-image-wrap">
                            <img class="speaking-task-image" src="<?= ACADEMY_URL ?>assets/img/practice_tests/CELPIP_PT_S_002/<?= $task['image'] ?>" alt="Task <?= $tNum ?> prompt image">
                        </div>
                        <?= $statusBar ?>
                    </div>
                <?php else: ?>
