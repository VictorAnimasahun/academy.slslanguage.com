...
<head>
    ...
    <title>CELPIP Writing Task 1 Practice 2 | EduHub</title>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">CELPIP Writing Task 1 Practice 2</li>
            </ol>
        </nav>
        <div class="stub-card">
            <span class="exam-badge">CELPIP</span>
            <h2 class="mb-2">CELPIP Writing Task 1 Practice 2</h2>
            <p class="text-muted mb-4">Writing Task 1 · 27 min</p>
            <div class="alert alert-info text-start">
                <i class="bi bi-folder2-open me-2"></i>
                <strong>Source writing set mapped:</strong><br>
                This task is tied to the downloaded CELPIP writing bundle under <code>Downloads/CELPIP TASKS/Celpip Writing / Task 2</code>.
            </div>
            <div class="alert alert-warning text-start">
                <i class="bi bi-hammer me-2"></i>
                <strong>Prompt conversion is pending.</strong><br>
                The page slot is registered so the prompt can be inserted and scored in the live writing workflow.
            </div>
