...
<head>
    ...
    <title>CELPIP Reading Practice 3 | EduHub</title>
...
<main class="main-wrapper">
    <div class="container">
        ...
        <div class="stub-card">
            ...
            <h2 class="mb-2">CELPIP Reading Practice 3</h2>
            <p class="text-muted mb-4">Reading · 4 Parts · 55 min</p>
            <div class="alert alert-info text-start">
                <i class="bi bi-folder2-open me-2"></i>
                <strong>Source task bundle mapped:</strong><br>
                This page is linked to the downloaded PDF and answer key set in <code>Downloads/CELPIP TASKS/Celpip Reading / Test 3</code>.
            </div>
            <div class="alert alert-warning text-start">
                <i class="bi bi-hammer me-2"></i>
                <strong>Question bank conversion is pending.</strong><br>
                The source material is attached to the project record and the migration entry is ready for final content conversion.
            </div>
