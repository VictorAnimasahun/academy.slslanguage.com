<?php
// IELTS Speaking Practice 003 — Swimming / Famous Business Person / Famous People
...
<head>
    ...
    <title>IELTS Speaking – Practice 3: Famous People | EduHub</title>
        ...
        <div class="test-container">
            <nav aria-label="breadcrumb" class="mb-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">IELTS Speaking – Practice 3</li>
                </ol>
            </nav>
