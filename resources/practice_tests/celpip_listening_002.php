<?php
/**
 * CELPIP Listening — Practice Test 2 (SCAFFOLD, no real content yet).
 *
 ...
 * celpip_listening_003.php / celpip_listening_004.php / the real PT1 —
 ...
 *
 * No real audio exists at assets/audio/CELPIP_PT_L_002/ yet — every widget
 ...
 * found") until a migration seeds CELPIP_PT_L_002 into the tests table.
 */
...
<head>
    ...
    <title>CELPIP Listening — Practice Test 2 | EduHub</title>
            ...
            <div class="d-flex align-items-center justify-content-between">
                <nav aria-label="breadcrumb" class="mb-0">
                    <ol class="breadcrumb mb-0" style="font-size:.8rem;">
                        ...
                        <li class="breadcrumb-item active">Listening Practice 2</li>
                    </ol>
                </nav>
