...
<head>
    ...
    <title>CELPIP Listening Practice 2 | EduHub</title>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">CELPIP Listening Practice 2</li>
            </ol>
        </nav>
        <div class="stub-card">
            <span class="exam-badge">CELPIP</span>
            <h2 class="mb-2">CELPIP Listening Practice 2</h2>
            <p class="text-muted mb-4">Listening · 8 Parts · 47 min</p>
            <div class="alert alert-info text-start">
                <i class="bi bi-folder2-open me-2"></i>
                <strong>Source task bundle mapped:</strong><br>
                This page is linked to the downloaded task set in <code>Downloads/CELPIP TASKS/Celpip Listening / Test 2</code>.
            </div>
            <div class="alert alert-warning text-start">
                <i class="bi bi-hammer me-2"></i>
                <strong>Source conversion is still in progress.</strong><br>
                The test entry is seeded in the migration set so it is reproducible in the project database while the full question bank is being converted.
            </div>
