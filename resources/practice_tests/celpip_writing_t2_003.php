...
<head>
    ...
    <title>CELPIP Writing Task 2 Practice 3 | EduHub</title>
    ...
    <div class="container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">CELPIP Writing Task 2 Practice 3</li>
            </ol>
        </nav>
        <div class="stub-card">
            <span class="exam-badge">CELPIP</span>
            <h2 class="mb-2">CELPIP Writing Task 2 Practice 3</h2>
            <p class="text-muted mb-4">Writing Task 2 · 26 min</p>
            <div class="alert alert-info text-start">
                <i class="bi bi-folder2-open me-2"></i>
                <strong>Source writing set mapped:</strong><br>
                This survey prompt slot is tied to the downloaded CELPIP Writing bundle under <code>Downloads/CELPIP TASKS/Celpip Writing / Test 3</code>.
            </div>
            <div class="alert alert-warning text-start">
                <i class="bi bi-hammer me-2"></i>
                <strong>Prompt conversion is pending.</strong><br>
                The project now records the task for the writing bank and keeps it reproducible from the source download bundle.
            </div>
