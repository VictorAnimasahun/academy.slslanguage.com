...
| Live  | [x] | 2026-09-23 | Reported by the instructor 2026-09-23: CELPIP 2-Month's Week 1 and Week 2 each showing 4 classes instead of 2 (screenshot showed "Foundational English Assessment" and "Mini Diagnostic — All 4 Skills" each appearing twice as separate classes). Origin of the duplicate rows on live not identified (113 only UPDATEs existing rows by lesson_order, doesn't insert). Generic across all courses/weeks, not just CELPIP_Gen_2Mo. Ran on live, confirmed by the instructor: no errors, and the course page now shows 2 classes per week in both Week 1 and Week 2. |
...
## 126 — lesson_parts: what each piece of a class IS, and the page that holds it
...
## 133 — IELTS Academic Reading Practice Test 2 (Cambridge IELTS 17 Academic, Test 2) wired to "Reading Test 2"
