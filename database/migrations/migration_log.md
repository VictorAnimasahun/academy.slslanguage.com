...
| Live  | [ ] | | ⚠️ **Run this file with an explicit UTF-8 client charset** — see warning below. If run via phpMyAdmin's import, its default charset is already UTF-8 so this is a non-issue there; this only matters for a raw `mysql` CLI import. |
...
| Live  | [ ] | | ⚠️ Same charset warning as migration 073 applies here — see this file's header comment. |
